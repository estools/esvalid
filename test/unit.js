...
suite("unit", function(){
  ...
  test("ObjectExpression", function() {
    ...
    validExpr({type: "ObjectExpression", properties: [{kind: "init", key: STR, value: EXPR}, {kind: "init", key: STR, value: EXPR}]});
    validExpr(FE(exprStmt({type: "Literal", value: "use strict"}), exprStmt({type: "ObjectExpression", properties: [{kind: "init", key: {type: "Literal", value: "hasOwnProperty"}, value: EXPR}]})));
    ...
    invalidExpr(1, FE(exprStmt({type: "Literal", value: "use strict"}), exprStmt({type: "ObjectExpression", properties: [{kind: "init", key: STR, value: EXPR}, {kind: "init", key: STR, value: EXPR}]})));
  });
